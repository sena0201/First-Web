        ...
        <div className={cx('inner')}>
            ...
            <div className={cx('search')}>
                <div className={cx('search-container')}>
                    <input placeholder="Tìm kiếm" className={cx('search-input')} spellCheck={false} />
                    <span className={cx('line')}></span>
                    <button className={cx('clear-btn')}><AiFillCloseCircle /></button>
            ...
            <div className={cx('action')}>
                ...
                <button className={cx('log-in-btn')}>Đăng nhập</button>
                <FiMoreVertical className={cx('more-icon')} />
            </div>
        </div>
    </header>
}
